...
Navigation (My fork): **Server repository** | [Client repository][1] | [Sprite repository][2]

  [1]: https://github.com/BabyGrootTheEpic/Insurgence-Client
  [2]: https://github.com/BabyGrootTheEpic/Sprites

========================================================================

Navigation (Smogon): [Website][1] | **Server repository** | [Client repository][2] | [Dex repository][3]
