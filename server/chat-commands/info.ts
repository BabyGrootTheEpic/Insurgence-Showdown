...
export const commands: Chat.ChatCommands = {
	addedfeatures(target, room, user) {
		...
		this.sendReplyBox(
			...
			`<li>Zeta &amp; Omicron: <a href="https://pokemonzetaomicron.fandom.com/wiki/Starter_Pok%C3%A9mon#Stat_Modifications">Starters</a>, <a href="https://pokemonzetaomicron.fandom.com/wiki/Special_Pokemon#Obtainable_Delta_Pok.C3.A9mon">Delta Pok&eacute;mon</a>, <a href="https://pokemonzetaomicron.fandom.com/wiki/Fakemon">Fakemon</a>, <a href="https://pokemonzetaomicron.fandom.com/wiki/Special_Pokemon#Shadow_Pok.C3.A9mon">Shadow Pok&eacute;mon (NYI)</a>, <a href="https://pokemonzetaomicron.fandom.com/wiki/Strange_Machine">Strange Machine Mewtwo</a>, Mega Dugtrio, Mega Golurk, &amp; an additional Mega Evolution for Sceptile and Swampert.</li></ul>` +
