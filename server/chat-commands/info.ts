...
export const commands: Chat.ChatCommands = {
	addedfeatures(target, room, user) {
		...
		this.sendReplyBox(
			...
			`<p><strong>Added Moves:</strong> All new moves from <a href="https://serebii.net/legendsarceus/newattacks.shtml">Legends: Arceus (WIP)</a>, <a href="https://wiki.p-insurgence.com/Category:Moves">Insurgence</a>, &amp; <a href="https://pokemonzetaomicron.fandom.com/wiki/Category:Exclusive_Moves">Zeta/Omicron (WIP)</a> have been added. Two custom moves, Give Balloon and Frigid Wind, have also been added.</p>` +
