...
export const commands: Chat.ChatCommands = {
	...
	coverage(target, room, user) {
		...
		if (!dispTable) {
			...
			for (const type of dex.types.names()) {
				icon[type] = `<img src="https://raw.githubusercontent.com/BabyGrootTheEpic/Sprites/main/play.pokemonshowdown.com/sprites/types/${type.replace(/\?/g, 'Q')}.png" width="32" height="14">`;
				// row of icons at top
