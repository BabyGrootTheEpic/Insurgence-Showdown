...
export const Chat = new class {
	...
	getDataPokemonHTML(species: Species, gen = 8, tier = '') {
		...
		if (species.types) {
			for (const type of species.types) {
				buf += `<img src="https://raw.githubusercontent.com/BabyGrootTheEpic/Sprites/main/play.pokemonshowdown.com/sprites/types/${type.replace(/\?/g, 'Q')}.png" alt="${type}" height="14" width="32">`;
			}
		}
		buf += '</span> ';
		if (gen >= 3) {
	...
	getDataMoveHTML(move: Move) {
		...
		buf += `<span class="col typecol"><img src="//raw.githubusercontent.com/BabyGrootTheEpic/Sprites/main/play.pokemonshowdown.com/sprites/types/${encodedMoveType.replace(/\?/g, 'Q')}.png" alt="${move.type}" width="32" height="14">`;
		buf += `<img src="//raw.githubusercontent.com/BabyGrootTheEpic/Sprites/main/play.pokemonshowdown.com/sprites/categories/${move.category}.png" alt="${move.category}" width="32" height="14"></span> `;
		if (move.basePower) {
