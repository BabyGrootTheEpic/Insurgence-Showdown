export const Items: {[itemid: string]: ItemData} = {
	...
	eeviumz: {
		...
		itemUser: ["Eevee", "Eevee-Tutored", "Eevee-Starter"],
		num: 805,
		gen: 7,
		//isNonstandard: "Past",
	},
	...
	eviolite: {
		...
		onModifyDef(def, pokemon) {
			if (pokemon.baseSpecies.nfe || pokemon.baseSpecies.name === 'Eevee-Tutored') {
				return this.chainModify(1.5);
			}
		},
		onModifySpDPriority: 2,
	...
	lightball: {
		...
		itemUser: ["Pikachu", "Pikachu-Delta", "Pikachu-Cosplay", "Pikachu-Rock-Star", "Pikachu-Belle", "Pikachu-Pop-Star", "Pikachu-PhD", "Pikachu-Libre", "Pikachu-Original", "Pikachu-Hoenn", "Pikachu-Sinnoh", "Pikachu-Unova", "Pikachu-Kalos", "Pikachu-Alola", "Pikachu-Partner", "Pikachu-Starter", "Pikachu-World"],
		num: 236,
		gen: 2,
	},
	lightclay: {
