export const Conditions: {[k: string]: ConditionData} = {
	...
	dynamax: {
		...
		onStart(pokemon) {
			...
			if (pokemon.gigantamax && pokemon.species.canGigantamax) this.add('-formechange', pokemon, pokemon.species.name + '-Gmax');
		...
		onEnd(pokemon) {
			...
			if (pokemon.gigantamax && pokemon.species.canGigantamax) this.add('-formechange', pokemon, pokemon.species.name);
			if (pokemon.baseSpecies.name === 'Shedinja') return;
