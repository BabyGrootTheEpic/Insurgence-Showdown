export const DefaultText: {[k: string]: DefaultText} = {
	...
	// splinters
	splinters: {
		start: "  Jagged splinters dug into [POKEMON]!",
		end: "  [POKEMON] shook off its splinters!",
		//alreadyStarted: "  [POKEMON] already has splinters!",
		//activate: "  [POKEMON] is confused!",
		damage: "  [POKEMON] was hurt by the jagged splinters digging into it!",
	},
	splintersnormal: {
		start: "  Jagged splinters dug into [POKEMON]!",
		end: "  [POKEMON] shook off its splinters!",
